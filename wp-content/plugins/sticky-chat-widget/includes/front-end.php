...
class GP_Front_Sticky_Chat_Buttons
{
    ...
    public function front_end_script()
    {
        ...
        if ($this->isWidgetActive) {
            ...
            wp_enqueue_script('gsb-script', GSB_PLUGIN_URL . "assets/front/js/script" . $minified . ".js", ['jquery'], GSB_PLUGIN_VERSION,true);

            // Enqueue front-end CSS.
            wp_enqueue_style('gsb-front', GSB_PLUGIN_URL . "assets/front/css/front" . $minified . ".css", [], GSB_PLUGIN_VERSION);
