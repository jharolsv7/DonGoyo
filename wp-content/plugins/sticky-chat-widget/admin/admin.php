                                                    ...
                                                    <div class="gp-form-input">
                                                        ...
                                                        $settings         = [
                                                            ...
                                                            'tinymce'          => [
                                                                ...
                                                                'toolbar2' => '',
                                                                'toolbar3' => '',
                                                                'content_css' => GSB_PLUGIN_URL . '/assets/admin/css/myEditorCSS.css'
                                                            ],
                                                        ];
                                    ...
                                    <div class="tab-setting-section" id="whatsapp_general_setting">
                                        ...
                                        <div class="gp-form-field in-flex">
                                            ...
                                            <div class="gp-form-input">
                                                ...
                                                <?php if (!empty($disabled)) { ?>
                                                    <a class="upgrade-link" href="javascript:;" target="_blank"><?php esc_html_e('Go Pro', 'sticky-chat-widget') ?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="gp-form-field in-flex">
                                            ...
                                            <div class="gp-form-input">
                                                ...
                                                <?php if (!empty($disabled)) { ?>
                                                    <a class="upgrade-link"
                                                       href="javascript:;"
                                                       target="_blank"><?php esc_html_e('Go Pro', 'sticky-chat-widget') ?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="gp-form-field in-flex">
...
<!--                                                <label>--><?php //esc_html_e("Form Settings", "sticky-chat-widget") ?><!--</label>-->
    ...
    public function admin_script($hook)
    {
        ...
        if ($hook == 'toplevel_page_sticky-chat-widget') {
            ...
            wp_enqueue_script('gsb-admin-script', GSB_PLUGIN_URL . "assets/admin/js/script" . $minified . ".js", ['jquery', 'wp-color-picker', 'jquery-ui-draggable', 'jquery-ui-droppable', 'jquery-ui-sortable', 'jquery-ui-slider'], GSB_PLUGIN_VERSION,true);

            // Enqueue Ajax submit script
            wp_enqueue_script('gsb-admin-ajax-script', GSB_PLUGIN_URL . "assets/admin/js/jquery.ajaxsubmit.js", [], GSB_PLUGIN_VERSION,true);

            // Enqueue SumoSelect script
            wp_enqueue_script('gsb-sumo-select-script', GSB_PLUGIN_URL . "assets/admin/js/jquery.sumoselect.min.js", [], GSB_PLUGIN_VERSION,true);

            // Enqueue International Telephone Input script
            wp_enqueue_script("gsb-country-min", GSB_PLUGIN_URL . 'assets/admin/js/intlTelInput-jquery.min.js', ['jquery'], GSB_PLUGIN_VERSION,true);

            // Enqueue WordPress color picker styles
            wp_enqueue_style('wp-color-picker');

            // Enqueue Font Awesome styles
            wp_enqueue_style('ssb-font-awesome', GSB_PLUGIN_URL . "assets/admin/css/fontwesome.all.min.css", [], GSB_PLUGIN_VERSION);

            // Enqueue SumoSelect styles
            wp_enqueue_style('gsb-sumo-select', GSB_PLUGIN_URL . "assets/admin/css/sumoselect.css", [], GSB_PLUGIN_VERSION);

            // Enqueue main admin styles
            wp_enqueue_style('gsb-admin-style', GSB_PLUGIN_URL . "assets/admin/css/style" . $minified . ".css", [], GSB_PLUGIN_VERSION);

            // Enqueue custom admin styles
            wp_enqueue_style('gsb-admin-custom-style', GSB_PLUGIN_URL . "assets/admin/css/custom" . $minified . ".css", [], GSB_PLUGIN_VERSION);

            // Enqueue International Telephone Input styles
            wp_enqueue_style('gsb-admin-country', GSB_PLUGIN_URL . "assets/admin/css/intlTelInput.css", [], GSB_PLUGIN_VERSION);

            // Enqueue the right-to-left (RTL) stylesheet for the GSB plugin's admin section.
            wp_enqueue_style('gsb-rtl-style', GSB_PLUGIN_URL . "assets/admin/css/style-rtl.css", [], GSB_PLUGIN_VERSION);

            // Enqueue WordPress media scripts
            wp_enqueue_media();

            // Enqueue additional scripts for Picmo
            wp_enqueue_script("gsb-picmo-umd", GSB_PLUGIN_URL . 'assets/admin/js/picmo-umd.min.js', ['jquery'], GSB_PLUGIN_VERSION, true);
            wp_enqueue_script("gsb-picmo-latest-umd", GSB_PLUGIN_URL . 'assets/admin/js/picmo-latest-umd.min.js', ['jquery'], GSB_PLUGIN_VERSION, true);

            // Check and enqueue signup styles if needed
            $flag = get_option($this->slug . "-subscribe-hide");
            if ($flag == false) {
                wp_enqueue_style($this->slug . '-signup-style', GSB_PLUGIN_URL . "assets/admin/css/sign-up" . $minified . ".css", [], GSB_PLUGIN_VERSION);
            }
            ...
            wp_enqueue_script('gsb-admin-ajax-script', GSB_PLUGIN_URL . "assets/admin/js/jquery.ajaxsubmit.js", [], GSB_PLUGIN_VERSION,true);
            wp_enqueue_script('gsb-date-time-picker', GSB_PLUGIN_URL . "assets/admin/js/jquery.datetimepicker.min.js", [], GSB_PLUGIN_VERSION,true);
            wp_enqueue_style('gsb-date-time-picker-css', GSB_PLUGIN_URL . "assets/admin/css/jquery.datetimepicker.min.css", [], GSB_PLUGIN_VERSION);
            wp_enqueue_style('gsb-admin-style', GSB_PLUGIN_URL . "assets/admin/css/style" . $minified . ".css", [], GSB_PLUGIN_VERSION);
            wp_enqueue_style('gsb-admin-custom-style', GSB_PLUGIN_URL . "assets/admin/css/custom" . $minified . ".css", [], GSB_PLUGIN_VERSION);
            wp_enqueue_style('gsb-admin-custom-style-leads', GSB_PLUGIN_URL . "assets/admin/css/leads-css" . $minified . ".css", [], GSB_PLUGIN_VERSION);
            wp_enqueue_script('gsb-admin-script', GSB_PLUGIN_URL . "assets/admin/js/leads-js" . $minified . ".js", ['jquery'], GSB_PLUGIN_VERSION,true);
    ...
    public function admin_menu()
    {
        ...
        add_menu_page(
            ...
            esc_url(GSB_PLUGIN_URL . "assets/admin/images/scw-icon.png") // Icon URL
        );
