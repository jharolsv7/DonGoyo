...
class GP_Admin_Common_Sticky_Chat_Widget
{
    ...
    public function admin_script($hook)
    {
        ...
        if ($hook == "plugins.php") {
            wp_enqueue_script($this->slug.'-admin-deactivate-plugin', GSB_PLUGIN_URL."assets/admin/js/deactivate-plugin.js", ['jquery'], GSB_PLUGIN_VERSION,true);
            wp_enqueue_style($this->slug.'-admin-deactivate-plugin', GSB_PLUGIN_URL."assets/admin/css/deactivate-plugin.css", [], GSB_PLUGIN_VERSION);
        ...
        wp_enqueue_script($this->slug.'-admin-script', GSB_PLUGIN_URL."assets/admin/js/common-script".$minified.".js", ['jquery'], GSB_PLUGIN_VERSION,true);

        // Enqueue common admin style.
        wp_enqueue_style($this->slug.'-admin-style', GSB_PLUGIN_URL."assets/admin/css/admin-style.min.css", [], GSB_PLUGIN_VERSION);
