        ...
        <div class="gp-form-input">
            <div class="image-radio-buttons in-flex">
                <div class="image-radio-button">
                    ...
                    <label for="view_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/icon-view.svg"; ?>'></label>
                    <label for="view_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/icon-view-selected.svg"; ?>'></label>
                ...
                <div class="image-radio-button">
                    ...
                    <label for="view_list" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/list-view.svg"; ?>'></label>
                    <label for="view_list" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/list-view-selected.svg"; ?>'></label>
                ...
                <div class="image-radio-button">
                    ...
                    <label for="view_grid" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/grid-view.svg"; ?>'></label>
                    <label for="view_grid" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/grid-view-selected.svg"; ?>'></label>
                ...
                <div class="image-radio-button">
                    ...
                    <label for="corner_circle_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/corner-circle.svg"; ?>'></label>
                    <label for="corner_circle_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/corner-circle-selected.svg"; ?>'></label>
                ...
                <div class="image-radio-button">
                    ...
                    <label for="menu_icon" class="radio-image"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/menu-view.svg"; ?>'></label>
                    <label for="menu_icon" class="radio-image-checked"><img src='<?php echo esc_url(GSB_PLUGIN_URL) . "assets/admin/images/menu-view-selected.svg"; ?>'></label>
