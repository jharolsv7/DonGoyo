                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-link"><a class="" href="<?php echo esc_attr($post->page_url) ?>" target="_blank"><?php echo $formIcons['to_link'] ?></a></td>
                            <td class="action-col"><span class="delete-single-lead trash-record" data-id="<?php echo esc_attr($post->id) ?>" data-nonce="<?php echo esc_attr(wp_create_nonce("remove_single_lead_nonce".esc_attr($post->id))) ?>"><?php echo $formIcons['trash'] ?></span></td>
                        </tr>
                        <?php
                        } ?>
